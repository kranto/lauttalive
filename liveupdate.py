...
rest_base_uri = 'https://meri-aws-test.digitraffic.fi/api/v1'
mqtt_host = 'meri-aws-mqtt-test.digitraffic.fi'
mqtt_host = 'b-afca9ce3-f38d-459d-b495-43d879decdaa-2.mq.eu-west-1.amazonaws.com'
mqtt_port = 9001
mqtt_port = 61619
...
def on_connect(client, userdata, flags, rc):
    print "on_connect"
    client.subscribe("vessels/230987870/#")
